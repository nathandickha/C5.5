...
function createProfiledFloorGeometryFromPolygon(perimeter2D, bb, params, tileSize, axisStartWallX, axisEndX, originX) {
  ...
  function addVertex(x, y) {
    const z = computeRectangleDepthAtX(x, params, axisStartWallX, axisEndX, originX);
...
class PoolBuilder {
  ...
  build() {
    ...
    this.group.userData.stepFootprintLen = Math.max(0, originX - axisStartWallX);
